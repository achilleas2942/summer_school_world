#ifndef SUMMER_SCHOOL_WORLD_COMMON_H_
#define SUMMER_SCHOOL_WORLD_COMMON_H_
...
namespace summer_school_world
{
	...
	template <typename T>
	inline void GetParameter(const ros::NodeHandle &nh, T *value,
	...
	template <typename T>
	inline void GetParameterArray(const ros::NodeHandle &nh, T *value,
								  const std::string &key, const T &def_value)
	{
		ROS_ASSERT(value != nullptr);
